# TODO Создайте абстрактный класс автомобиля Transport c абстрактными методами
# - start_engine
# - stop_engine
# - move
# - stop

# TODO Унаследуйте от него три класса Boat, Car, Electroscooter
...
# TODO Создайте класс Person у которого будет один единственный метод use_transport.
...
class Boat(Transport):
    def start_engine(self):
        print(f'Двигатель запущен. Катер затарахтел своим дизельным агрегатом')

    def stop_engine(self):
        print(f'Двигатель катера чихнул напоследок и заглох')

    def move(self):
        print(f'Катер быстро набирает скорость')

    def stop(self):
        print(f'Катер остановился')


class Car(Transport):
    def start_engine(self):
        print(f'Двигатель запущен. Машина заурчала своим новеньким мотором')

    def stop_engine(self):
        print(f'Машина стоит с заглушенным двигателем')

    def move(self):
        print(f'Машина едет к цели назначения')
...
class Electroscooter(Transport):
    def start_engine(self):
        print(f'Двигатель запущен. Нет топлива, нет звука. Работает бесшумно')

    def stop_engine(self):
        print(f'Двигатель остановлен. Мигнул светодиодом дважды')

    def move(self):
        print(f'Прохожие в ужасе разбегаются от очередного камикадзе')

    def stop(self):
        print(f'Торможение об стену прошло успешно')
